...
DATA(insert OID = 6015 (  cfs_start_gc		   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 23 "23" _null_ _null_ _null_ _null_ _null_ cfs_start_gc _null_ _null_ _null_ ));
DESCR("cfs_start_gc start CFS garbage collection");
DATA(insert OID = 6016 (  cfs_version		   PGNSP PGUID 12 1 0 0 0 f f f f t f s s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ cfs_version _null_ _null_ _null_ ));
